...
法的規制: 宝くじは、法律上全ての国で民間企業ができない

参入障壁: ブロックチェーンを使った宝くじの事例がないので導入しずらい

- world wide lottery
- 政府系宝くじ
- credit card pay to 宝くじ

### world wide lottery

国境がなく世界中の人が参加できる宝くじ。
宝くじよって得られる利益は、各国に税収になる。
例えば、アメリカ人が買った宝くじチケットの料金の50%はアメリカの税金として、送金され、残り50%が、宝くじの賞金として、使われる。
全世界からお金を集めて、宝くじをするので、当選金は多くなり、参加者は増え、各国の税収も多くなる。

### 政府系宝くじ

政府がチケットを発行して、国民がチケットを購入して、政府は税収を確保する
...
宝くじの運営が、クレジットカードを発行して、ユーザーに配布し、ユーザーは普通のカードと同じように買い物をする。
ユーザーが買い物をすると、カードネットワークを管理している会社(visa, master)が、使用量の1.75% をカード発行会社に手数料として支払います。

この手数料から儲けた利益を収益の一部を宝くじとして、分配する。

カード発行会社は会員を集めるために、ポイント制度などを取っている。

visaのカード発行会社をissuerといいます。
...
この宝くじでは、ユーザーは損失がなく宝くじに参加することができます。

普段使っているカードを宝くじクレジットカードに変えるだけで、億万長者になる道が誰にもで開かれるのです。

**課題**

クレジットカードを使って少額のポイントをもらうより、宝くじのように当たったら、たくさんもらえる方にかけたい。
...
twitterのリツイートや、ボランティアやイベントへの参加など

何をトリガーにして宝くじのチケットを配布するのかは、developerが自由に開発できます。

**課題**

小さいプロジェクトで、何かをするときに大きなインセンティブを、参加者に与えることはできない。

twitterのリツイート企画などはたくさん見られますが、その多くが、本当にプレゼントやお金を配布しているのか、当選者をランダムに当選させているのかは、わかりません。

### 組織内宝くじ

会社などで、良い働きをした人に、宝くじのチケットを配布し, 月末や年末に利益の一部を当選者に送金する
組織内で働くことのインセンティブを作ることができる。

**代替元**

ストックオプション、ボーナス、案件ごとのインセンティブ

**課題**

ストックオプションのインセンティブは上場するまでに数年かかり、インセンティブが反映されるまでに時間がかかる。
一案件獲得ごとにセールスマンにインセンティブを上げるようにすると組織内での協力を促すことはできない。
